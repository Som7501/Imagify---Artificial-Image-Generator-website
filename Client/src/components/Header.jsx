...
const Header = () => {
  ...
  return (
    ...
    text-center my-20'>
        ...
        className='text-stone-500 text-center inline-flex
        gap-2 bg-white px-6 py-1 rounded-full border
        border-neutral-500'>

            <p>Beat text to image generator</p>
        ...
        sm:max-w-[600px] mx-auto mt-10 text-center'>
            Turn text into {" "}
        ...
        className='text-center max-w-xl mt-5 mx-auto'>
        ...
        className='flex text-white sm:text-lg bg-black
        w-auto mt-8 px-12 py-2.5 items-center cursor-pointer
        gap-2 rounded-full'>
            Generate Images
